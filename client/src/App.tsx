...
const ComplusOutOfWarrantyBillingPage = lazy(() => import("@/pages/admin/complus-out-of-warranty-billing"));
...
function Router() {
  return (
    <Suspense fallback={<LoadingFallback />}>
      ...
      <RoleProtectedRoute path="/admin/complus-out-of-warranty-billing" component={ComplusOutOfWarrantyBillingPage} allowedRoles={["admin"]} />

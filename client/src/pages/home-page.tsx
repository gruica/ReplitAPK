  ...
  return (
    <>
      <SEO 
        ...
        description="🔧 Profesionalni servis bele tehnike u Kotoru, Crna Gora. ⚡ Brza dijagnostika, originalni delovi, 12 meseci garancije. Frižideri, veš mašine, sudopere, šporeti. Pozovite 033 402 402 - dostupni 24/7!"
        keywords="servis bele tehnike kotor, popravka frizidera kotor, servis veš mašina kotor, servis sudopera, beko servis, candy servis, hoover servis, rezervni delovi kotor"
        ogTitle="Frigo Sistem Todosijević - Profesionalni Servis Bele Tehnike"
        ogDescription="Profesionalni servis bele tehnike u Kotoru. Brza dijagnostika, originalni delovi, 12 meseci garancije."
        canonical="https://www.tehnikamne.me/"
      />

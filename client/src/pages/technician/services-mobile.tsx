            ...
            <div>
              ...
              <Select value={unavailableReason} onValueChange={setUnavailableReason}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="invalid_number">Neispravan broj</SelectItem>
                  <SelectItem value="client_unavailable">Nedostupan klijent</SelectItem>
                  <SelectItem value="no_phone_answer">Klijent se ne javlja na telefon</SelectItem>
                  <SelectItem value="nonexistent_number">Nepostojeći broj</SelectItem>
                  <SelectItem value="client_disconnected">Isključen klijent</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="flex gap-2">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <MobileTextarea
                ...
                autoScrollOnFocus={true}
                dynamicHeight={true}
                data-testid="textarea-spare-parts-description"
              />
            </div>
            <div className="flex gap-2">
              <Button
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <MobileTextarea
                ...
                autoScrollOnFocus={true}
                dynamicHeight={true}
                data-testid="textarea-used-parts"
              />
            </div>
            ...
            <div>
              ...
              <MobileTextarea
                ...
                autoScrollOnFocus={true}
                dynamicHeight={true}
                data-testid="textarea-machine-notes"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <MobileTextarea
                ...
                autoScrollOnFocus={true}
                dynamicHeight={true}
                data-testid="textarea-replaced-parts"
              />
            </div>

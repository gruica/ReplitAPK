...
export default function TermsOfService() {
  return (
    <>
      <SEO 
        title="Uslovi Korišćenja - Frigo Sistem Todosijević | Pravila i Odredbe"
        description="Uslovi korišćenja i pravila - Frigo Sistem Todosijević. Informacije o našim uslugama, pravima i obavezama korisnika."
        keywords="uslovi korišćenja, pravila, odredbe, servis bele tehnike, garancija"
        canonical="https://www.tehnikamne.me/terms-of-service"
      />

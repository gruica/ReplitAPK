                        ...
                        <div className="flex items-start">
                          ...
                          <div className="flex-1">
                            <div className="bg-white p-4 rounded-md border border-blue-100">
                              <p className="text-gray-800 whitespace-pre-line leading-relaxed">{service.technicianNotes}</p>
                            </div>
                            {service.technician && (
                ...
                {service.status === 'completed' && (
                  <>
                    ...
                    <div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                              ...
                              {(service.completionReport?.warrantyStatus || service.warrantyStatus) && (
                                <div>
                                  <span className="text-green-700 font-medium">Status garancije:</span>
                                  <p className="text-green-800">{service.completionReport?.warrantyStatus || service.warrantyStatus}</p>
                                </div>
                              )}
                              {(service.completionReport?.totalCost || service.cost) && (
                                <div>
                                  <span className="text-green-700 font-medium">Ukupan trošak:</span>
                                  <p className="text-green-800 font-semibold">{service.completionReport?.totalCost || service.cost}</p>
                                </div>
                              )}
                            </div>
                          </div>
                      ...
                      {/* NOVO: Prikaz kompletnog izveštaja o radu */}
                        ...
                        <div className="space-y-4 mb-4">
                          ...
                          <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                            ...
                            <div className="bg-white p-3 rounded border">
                              <p className="text-gray-700 whitespace-pre-line">{service.completionReport.workDescription}</p>
                            </div>
                          </div>
                          ...
                          <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
                            ...
                            <div className="bg-white p-3 rounded border">
                              <p className="text-gray-700 whitespace-pre-line">{service.completionReport.problemDiagnosis}</p>
                            </div>
                          </div>
                          ...
                          <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                            ...
                            <div className="bg-white p-3 rounded border">
                              <p className="text-gray-700 whitespace-pre-line">{service.completionReport.solutionDescription}</p>
                            </div>
                          </div>
                              ...
                              <div className="bg-white p-3 rounded border">
                                {(() => {
                                  try {
                                    ...
                                    return <p className="text-gray-700">{service.completionReport.usedSpareParts}</p>;
                                  }
                                })()}
                              </div>
                            </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {service.completionReport.laborTime && (
                              <div className="bg-gray-50 border border-gray-200 p-3 rounded-lg">
                                <p className="text-sm text-gray-600">Vreme rada</p>
                                <p className="text-lg font-semibold text-gray-900">{service.completionReport.laborTime} min</p>
                              </div>
                            )}
                            {service.completionReport.clientSatisfaction && (
                              <div className="bg-gray-50 border border-gray-200 p-3 rounded-lg">
                                <p className="text-sm text-gray-600">Zadovoljstvo klijenta</p>
                                <p className="text-lg font-semibold text-gray-900">
                                  {service.completionReport.clientSatisfaction}/5 ⭐
                                </p>
                              </div>
                            )}
                            {service.completionReport.warrantyPeriod && (
                              <div className="bg-gray-50 border border-gray-200 p-3 rounded-lg">
                                <p className="text-sm text-gray-600">Period garancije</p>
                                <p className="text-lg font-semibold text-gray-900">{service.completionReport.warrantyPeriod}</p>
                              </div>
                            )}
                          </div>
                          ...
                          {service.completionReport.additionalNotes && (
                            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
                              ...
                              <div className="bg-white p-3 rounded border">
                                <p className="text-gray-700 whitespace-pre-line">{service.completionReport.additionalNotes}</p>
                              </div>
                            </div>
                          )}
                          ...
                          {service.completionReport.techniciansSignature && (
                            <div className="bg-gray-50 border border-gray-200 p-3 rounded-lg text-center">
                              <p className="text-sm text-gray-600">Potpis tehničara</p>
                              <p className="text-lg font-semibold text-gray-900 mt-1">{service.completionReport.techniciansSignature}</p>
                            </div>
                          )}
                        </div>
                      )}

                      {/* Stari prikaz - FALLBACK ako nema completion report */}

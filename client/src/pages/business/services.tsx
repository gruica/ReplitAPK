                ...
                <div className="p-4 space-y-3">
                  <div className="space-y-2">
                    ...
                    {service.technicianNotes && (
                      <div className="border-t pt-2 bg-blue-50/50 -mx-3 px-3 py-2">
                        <div className="text-xs font-semibold text-blue-600 mb-1 flex items-center">
                          <MessageSquare className="h-3 w-3 mr-1" />
                          Detaljan opis rada:
                        </div>
                        <div className="text-sm text-blue-700 font-medium max-h-10 overflow-hidden leading-snug">{service.technicianNotes}</div>
                      </div>
                    )}
              ...
              {selectedService.technicianNotes && (
                <div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                    <p className="text-sm text-gray-800 bg-white p-3 rounded-md border border-blue-100 whitespace-pre-line leading-relaxed">{selectedService.technicianNotes}</p>
                    <div className="mt-3 flex items-center text-xs text-blue-600">
                      {selectedService.technician && (
                        <span className="flex items-center font-medium">
                          <Wrench className="h-3 w-3 mr-1" />
                          {selectedService.technician.fullName}
                        </span>
                      )}

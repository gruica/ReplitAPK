...
export default function BusinessPartnersAdminPage() {
  ...
  // Filter services with proper null checks
  ...
  const uniquePartners = Array.from(new Set(services.map(s => s.businessPartner?.companyName).filter(Boolean)));
                              ...
                              {service.businessPartner && (
                                <div className="bg-purple-50 rounded-lg p-3 mb-3">
                                  <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="font-medium text-purple-900">{service.businessPartner.companyName || 'N/A'}</span>
                                  </div>
                                ...
                                {service.client && (
                                  <div className="bg-gray-50 rounded-lg p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                      ...
                                      <span className="font-medium text-gray-900">{service.client.fullName || 'N/A'}</span>
                                    </div>
                                ...
                                {service.appliance && (
                                  <div className="bg-blue-50 rounded-lg p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                      ...
                                      <span className="font-medium text-blue-900">{service.appliance.category?.name || 'N/A'}</span>
                                    </div>
